...
const SamplePost = () => {
  return (
    <>
      <header className="Samplepost-header">
        <div className="container">
          <div className="site-heading ">
            <h1>Man must explore, and this is exploration at its greatest</h1>
            <span>Problems look mighty small from 150 miles up</span>
            <span className="meta">
              Posted by
      ...
      <div className="samplepost container">
        <div className="content">
          ...
          <p>
            Placeholder text by{' '}
            <Link to="http://spaceipsum.com/">Space Ipsum</Link> · Images by{' '}
